<template>
    <main class="error-view grid h-screen w-screen min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
                ...
                <div class="select-none text-sm font-semibold text-gray-900">Contact support <span
